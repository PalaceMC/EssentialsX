            ...
            if (NumberUtil.isInt(groupValue)) {
                if (matchedList != null && !matchedList.isEmpty()) {
                    ...
                    if (matchedList.size() > limit) {
                        ...
                        sender.sendMessage(PlayerList.outputFormat(oConfigGroup, PlayerList.listUsers(ess, matchedList, ", ")));
                    }
                    continue;
                }
            }

            List<User> outputUserList = PlayerList.getMergedList(ess, playerList, configGroup);
